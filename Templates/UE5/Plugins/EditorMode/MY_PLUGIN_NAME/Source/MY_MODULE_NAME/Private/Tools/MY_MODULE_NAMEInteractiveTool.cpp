...
#include "MY_MODULE_NAMEInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMY_MODULE_NAMEInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMY_MODULE_NAMEInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMY_MODULE_NAMEInteractiveTool* NewTool = NewObject<UMY_MODULE_NAMEInteractiveTool>(SceneState.ToolManager);
...
UMY_MODULE_NAMEInteractiveToolProperties::UMY_MODULE_NAMEInteractiveToolProperties()
{
...
void UMY_MODULE_NAMEInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMY_MODULE_NAMEInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMY_MODULE_NAMEInteractiveToolProperties>(this, "Measurement");
...
void UMY_MODULE_NAMEInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMY_MODULE_NAMEInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMY_MODULE_NAMEInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMY_MODULE_NAMEInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMY_MODULE_NAMEInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMY_MODULE_NAMEInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMY_MODULE_NAMEInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMY_MODULE_NAMEInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMY_MODULE_NAMEInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
