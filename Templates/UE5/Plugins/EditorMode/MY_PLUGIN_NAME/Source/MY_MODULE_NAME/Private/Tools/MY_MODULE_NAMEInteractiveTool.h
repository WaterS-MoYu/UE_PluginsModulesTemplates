...
#include "MY_MODULE_NAMEInteractiveTool.generated.h"


/**
 * Builder for UMY_MODULE_NAMEInteractiveTool
 */
UCLASS()
class UMY_MODULE_NAMEInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMY_MODULE_NAMEInteractiveTool
 */
UCLASS(Transient)
class UMY_MODULE_NAMEInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMY_MODULE_NAMEInteractiveToolProperties();
...
/**
 * UMY_MODULE_NAMEInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class UMY_MODULE_NAMEInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMY_MODULE_NAMEInteractiveToolProperties> Properties;
