...
#include "MY_PLUGIN_NAMEEditorMode.generated.h"
 ...
 */
UCLASS()
class UMY_PLUGIN_NAMEEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_MY_PLUGIN_NAMEEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UMY_PLUGIN_NAMEEditorMode();
	virtual ~UMY_PLUGIN_NAMEEditorMode();
