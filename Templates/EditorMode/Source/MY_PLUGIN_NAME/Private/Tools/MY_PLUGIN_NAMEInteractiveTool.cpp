...
#include "MY_PLUGIN_NAMEInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UMY_PLUGIN_NAMEInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UMY_PLUGIN_NAMEInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UMY_PLUGIN_NAMEInteractiveTool* NewTool = NewObject<UMY_PLUGIN_NAMEInteractiveTool>(SceneState.ToolManager);
...
UMY_PLUGIN_NAMEInteractiveToolProperties::UMY_PLUGIN_NAMEInteractiveToolProperties()
{
...
void UMY_PLUGIN_NAMEInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UMY_PLUGIN_NAMEInteractiveTool::Setup()
{
	...
	Properties = NewObject<UMY_PLUGIN_NAMEInteractiveToolProperties>(this, "Measurement");
...
void UMY_PLUGIN_NAMEInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UMY_PLUGIN_NAMEInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UMY_PLUGIN_NAMEInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UMY_PLUGIN_NAMEInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UMY_PLUGIN_NAMEInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UMY_PLUGIN_NAMEInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UMY_PLUGIN_NAMEInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UMY_PLUGIN_NAMEInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UMY_PLUGIN_NAMEInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
