...
#include "MY_PLUGIN_NAMEInteractiveTool.generated.h"


/**
 * Builder for UMY_PLUGIN_NAMEInteractiveTool
 */
UCLASS()
class MY_PLUGIN_NAME_API UMY_PLUGIN_NAMEInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UMY_PLUGIN_NAMEInteractiveTool
 */
UCLASS(Transient)
class MY_PLUGIN_NAME_API UMY_PLUGIN_NAMEInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UMY_PLUGIN_NAMEInteractiveToolProperties();
...
/**
 * UMY_PLUGIN_NAMEInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class MY_PLUGIN_NAME_API UMY_PLUGIN_NAMEInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UMY_PLUGIN_NAMEInteractiveToolProperties> Properties;
